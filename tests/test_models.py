"""Tests for LSTM and Transformer models."""

import torch
import pytest

from src.models import LSTMPredictor, TransformerPredictor, build_model
...
def test_models_trainable(sample_input):
    """Verify both models can do a forward-backward pass."""
